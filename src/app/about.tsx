...
export default function AboutPhoenix({
    ...
    return (
        <section className="w-full max-w-5xl text-center px-6">
            <h2
            ...
            <p className={`text-gray-300 leading-relaxed ${textSize}`}>
                Phoenix is a cutting-edge AI-powered code generation tool
                designed to revolutionize the way developers write code. With
                advanced natural language understanding, Phoenix translates
                human intent into efficient, production-ready solutions across
